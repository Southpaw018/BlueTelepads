package me.specops.bluetelepads.register.payment;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new me.specops.bluetelepads.register.payment.methods.iCo6());
        this.addMethod("iConomy", new me.specops.bluetelepads.register.payment.methods.iCo5());
        this.addMethod("iConomy", new me.specops.bluetelepads.register.payment.methods.iCo4());
        this.addMethod("BOSEconomy", new me.specops.bluetelepads.register.payment.methods.BOSE6());
        this.addMethod("BOSEconomy", new me.specops.bluetelepads.register.payment.methods.BOSE7());
        this.addMethod("Essentials", new me.specops.bluetelepads.register.payment.methods.EE17());
        this.addMethod("MultiCurrency", new me.specops.bluetelepads.register.payment.methods.MCUR());
    }
